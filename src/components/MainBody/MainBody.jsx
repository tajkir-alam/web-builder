                ...
                sections.map((section) =>
                    <div key={section._id} className='my-8 relative w-full h-96 group border-[3px] border-transparent hover:border-gray-400 duration-300'>
                        ...
                        <div className='absolute text-center inset-y-1/4 w-2/5 left-[30%]'>
                            <h6 className='content-border capitalize text-[13.412px] text-[#69764A] font-semibold'>gift guide</h6>
                            <h3 className='content-border text-[36.224px] text-[#536136] font-bold'>Here’s to Joy</h3>
                            <p className='content-border text-[8.567px] text-[#7A8365] mb-[14px]'>
